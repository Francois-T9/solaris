          ...
          <div className="card-body">
            ...
            <ul className="mt-6 flex flex-col gap-2 text-xs">
              ...
              <li className="opacity-50">
                ...
                <span className="line-through">Bomba de agua</span>
              </li>
              <li className="opacity-50">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="line-through">Equipos de alto consumo</span>
              </li>
            </ul>
            <div className="mt-6">
          ...
          <div className="card-body">
            ...
            <ul className="mt-6 flex flex-col gap-2 text-xs">
              ...
              <li>
                ...
                <span>Equipos de alto consumo</span>
              </li>
            </ul>
            <div className="mt-6">
              <button className="btn btn-primary btn-block">Elegir</button>
